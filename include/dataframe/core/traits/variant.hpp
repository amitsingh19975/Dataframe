...
namespace amt{
    ...
    namespace traits{
        ...
        namespace impl{
            ...
            constexpr auto is_type_in_variant_helper(std::index_sequence<Is...>) noexcept -> bool{
        ...
        concept IsTypeInVariant = impl::is_type_in_variant_helper<T,V>(std::make_index_sequence< std::variant_size_v<V> >{} );
    } // namespace traits
