...
namespace amt{
    ...
    namespace traits{
        ...
        namespace impl{
            ...
            struct is_unbounded_storage< basic_unbounded_storage<StorageTraits, TypesUpperBound> > : std::true_type{};

        } // namespace impl
        
        template<typename T>
        concept UnboundedTypeStorage = impl::is_unbounded_storage<std::decay_t<std::remove_pointer_t<T>>>::value;
