...
namespace amt{
    ...
    namespace traits{
        ...
        namespace impl{
            ...
            struct is_bounded_type_storage< basic_bounded_storage<StorageTraits,Ts...> > : std::true_type{};

        } // namespace impl
        
        template<typename T>
        concept BoundedTypeStorage = impl::is_bounded_type_storage<std::decay_t<std::remove_pointer_t<T>>>::value;
