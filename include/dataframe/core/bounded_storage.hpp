...
namespace amt{
    ...
    public:
        ...
        constexpr basic_bounded_storage(basic_bounded_storage const&) = default;
        constexpr basic_bounded_storage(basic_bounded_storage &&) noexcept = default;
        constexpr basic_bounded_storage& operator=(basic_bounded_storage const&) = default;
        constexpr basic_bounded_storage& operator=(basic_bounded_storage &&) noexcept = default;
        constexpr ~basic_bounded_storage() noexcept = default;
        ...
        constexpr basic_bounded_storage(std::initializer_list<T> li)
        ...
        constexpr basic_bounded_storage(size_type size, T def)
        ...
        friend auto swap(basic_bounded_storage& lhs, basic_bounded_storage& rhs) noexcept -> void{
        ...
        constexpr auto operator==(basic_bounded_storage const& other) const noexcept -> bool{
            ...
            return binary_op(*this, other, [&res]<typename T, typename U>(T&& l, U&& r){
                ...
                if constexpr(traits::EqualityComparable<ltype,rtype>){
    ...
    using bounded_storage = basic_bounded_storage<S,
