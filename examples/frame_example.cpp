...
int main(int, char **) {
    ...
    // Operator Support
    {
        ...
        std::cout<<"F1 + F2: { "<<std::endl<<(fr + fr)<<"}"<<std::endl;
        std::cout<<std::endl;
    }
    ...
    // Free Function Accumulate
    {
        ...
        //[ Column: "Alphabet", Type: "std::string" ]{ "A", "B", "C", "D", "E" }
        std::cout<<"Frame : { "<<std::endl<<fr<<"}"<<std::endl;
        std::cout<<"Sum:    "<<amt::accumulate(fr, 0.f, std::plus<float>{})<<std::endl; // 15
        std::cout<<"Sub:    "<<amt::accumulate(fr, 0.f, std::minus<float>{})<<std::endl; // -15
        std::cout<<"Mul:    "<<amt::accumulate(fr, 1.f, std::multiplies<float>{})<<std::endl; // 120
        std::cout<<"Div:    "<<amt::accumulate(fr, 1.f, std::divides<float>{})<<std::endl; // 0.00833333
        std::cout<<std::endl;
    }
    ...
    // Free Function Drop Columns With Indices
    {
        ...
        std::cout<<"------------ Drop Using Column Index -------------"<<std::endl;
        //[ Column: "Number", Type: "std::int32_t" ]{ 1, 2, 3, 4, 5 }
        //[ Column: "Alphabet", Type: "std::string" ]{ "A", "B", "C", "D", "E" }
        std::cout<<"Before Frame          : { "<<std::endl<<fr<<"}"<<std::endl;
        
        //[ Column: "Alphabet", Type: "std::string" ]{ "A", "B", "C", "D", "E" }
        std::cout<<"Out Of Place Drop Cols: { "<<std::endl<< amt::drop_cols(fr, amt::out_place, amt::index_list{0})<<"}"<<std::endl;
        ...
        //[ Column: "Alphabet", Type: "std::string" ]{ "A", "B", "C", "D", "E" }
        std::cout<<"In Place Drop Cols: { "<<std::endl<< amt::drop_cols(fr, amt::in_place, amt::index_list{0})<<"}"<<std::endl;
    ...
    // Free Function Drop Columns With Column Name
    {
        ...
        std::cout<<"------------ Drop Columns Using Column Name -------------"<<std::endl;
        //[ Column: "Number", Type: "std::int32_t" ]{ 1, 2, 3, 4, 5 }
        //[ Column: "Alphabet", Type: "std::string" ]{ "A", "B", "C", "D", "E" }
        std::cout<<"Before Frame          : { "<<std::endl<<fr<<"}"<<std::endl;
        
        //[ Column: "Number", Type: "std::int32_t" ]{ 1, 2, 3, 4, 5 }
        std::cout<<"Out Of Place Drop Cols: { "<<std::endl<< amt::drop_cols(fr, amt::out_place, amt::name_list{"Alphabet"})<<"}"<<std::endl;
        ...
        //[ Column: "Number", Type: "std::int32_t" ]{ 1, 2, 3, 4, 5 }
        std::cout<<"In Place Drop Cols: { "<<std::endl<< amt::drop_cols(fr, amt::in_place, amt::name_list{"Alphabet"})<<"}"<<std::endl;
    ...
    // Free Function Drop Rows
    {
        ...
        std::cout<<"Out Of Place Drop Rows: { "<<std::endl<< amt::drop_rows(fr, amt::out_place, amt::index_list{0,3,2})<<"}"<<std::endl;
        ...
        //[ Column: "Number", Type: "float" ]{ 2, 5 }
        //[ Column: "Alphabet", Type: "std::string" ]{ "B", "E" }
        std::cout<<"In Place Drop Rows: { "<<std::endl<< amt::drop_rows(fr, amt::in_place, amt::index_list{0,3,2})<<"}"<<std::endl;
    ...
    // Free Function Filter
    {
        ...
        std::cout<<"Out Of Place Filter: { "<<std::endl<< amt::filter(fr, amt::out_place, even)<<"}"<<std::endl;
        ...
        //[ Column: "Number", Type: "std::int32_t" ]{ 2, 4 }
        //[ Column: "Alphabet", Type: "std::string" ]{ "B", "D" }
        std::cout<<"In Place Filter: { "<<std::endl<< amt::filter(fr, amt::in_place, even)<<"}"<<std::endl;
    ...
    // Free Function Transform
    {
        ...
        //[ Column: "Alphabet", Type: "std::string" ]{ "A", "B", "C", "D", "E" }
        std::cout<<"Out Of Place Transform: { "<<std::endl<< amt::transform(fr, amt::out_place, sq)<<"}"<<std::endl;
        ...
        //[ Column: "Number", Type: "std::int32_t" ]{ 1, 4, 9, 16, 25 }
        //[ Column: "Alphabet", Type: "std::string" ]{ "A", "B", "C", "D", "E" }
        std::cout<<"In Place Transform: { "<<std::endl<< amt::transform(fr, amt::in_place, sq)<<"}"<<std::endl;
    ...
    // Free Function To
    {
        ...
        std::cout<<"Out Of Place To: { "<<std::endl<< amt::to<float>(fr, amt::out_place)<<"}"<<std::endl;
        ...
        //[ Column: "Number", Type: "float" ]{ 1, 2, 3, 4, 5 }
        //[ Column: "Alphabet", Type: "float" ]{ 1, 2, 3, 4, 5 }
        std::cout<<"In Place To : { "<<std::endl<< amt::to<float>(fr, amt::in_place)<<"}"<<std::endl;
    ...
    // Frame View
    {
        ...
        std::cout<<"V1: { "<<std::endl<<fr(amt::slice(amt::slice_stride(2)), amt::slice(0ul,5ul, 2ul) )<<"}"<<std::endl;
        
        //[ Column: "Number", Type: "std::int32_t" ]{ 1, 2, 3, 4, 5 }
        //[ Column: "Char Label", Type: "std::int8_t" ]{ a, b, c, d, e }
        std::cout<<"V2: { "<<std::endl<<fr(amt::slice(amt::slice_stride(2)))<<"}"<<std::endl;
